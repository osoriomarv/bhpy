...
# Originally inspired by Black Hat Python by Justin Seitz
# Then modified by TokyoEnigma to work with Python 3
# Taken from "https://github.com/EONRaider/blackhat-python3/blob/master/chapter02/bhnet.py"
